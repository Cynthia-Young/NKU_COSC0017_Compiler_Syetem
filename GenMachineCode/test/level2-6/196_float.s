...
main:
	...
	sub sp, sp, #28
.L134:
	vldr.32 s31, =1033895936
	vldr.32 s30, =3338725376
	vmov s1, s30
	vmov s0, s31
	bl  float_eq
	mov r10, r0
	...
	mov r0, r10
	bl  assert
	vldr.32 s31, =1119752445
	vldr.32 s30, =1107966695
	vmov s1, s30
	vmov s0, s31
	bl  float_eq
	mov r10, r0
	...
	mov r0, r10
	bl  assert
	vldr.32 s31, =1130954752
	vldr.32 s30, =1166012416
	vmov s1, s30
	vmov s0, s31
	bl  float_eq
	mov r10, r0
